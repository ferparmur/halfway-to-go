...
as soon as possible to the following edition, which was called "The Marrakesh
Express", and would cover the 2,300 km between London and Marrakesh from 17th to
24th May 2025.
...
all-time favourite destinations, having been there multiple times.
...
allowed, but taxis are only permissible within city limits, and you can't catch
an airplane, helicopter or hot-air balloon. Whilst you know the start and end
...
English Channel would be otherwise prohibitively expensive or outright
impossible. For this race, we know that the first checkpoint is going to be
situated in Paris.

So this adventure starts with me heading to the Herne Hill Velodrome in South
London, in the company, once again, of my ever supportive wife, Cris. We arrive
to Brixton station, on the Victoria Line, which is not the closest station to
the Velodrome, but is the nearest one within the area of coverage of the TfL
cycle hire scheme, aka Boris bikes.

You see, in previous editions the race started from Trafalgar Square, which made
it trivial to get to St Pancras station where the Eurostar departs: a quick hop
on the Piccadilly line of the Tube and you arrive there in less than 20 minutes
without breaking a sweat. This time, however, the start has moved to the
aforementioned Herne Hill Velodrome, an iconic venue that hosted the cycling
events of the 1948 London Olympics.

The first challenge us racers are facing is getting from there across London to
...
quite slim, so sweating that early into it is not appealing at all. Second,
...
With all of that in mind, I came up with a different plan: getting an electric
bike from the closest docking station, carrying it to the Velodrome with me, and
using it to get back to Brixton. On the one hand, that means not having internet
access for the half an hour or so that it will take me to get there. On the
other, Victoria line trains are fast and frequent, and I could even get to the
Eurostar boarding area a couple of minutes earlier than if I were to take the
Thameslink train.

We arrive, bike in hand, to the velodrome a little bit after the advertised
opening time of 9:00 AM. I go to check in and get my race pack (which we are
strictly prohibited to open before the race starts), GPS tracker, and swag; and
say hello to the organizing team and other racers that I met during last year's
edition. It's soon time to line up in the starting line and listen to the
checkpoint reveal.
...
- **Paris**, where racers will have to clear two checkpoints, depending on which
  route they'll choose.

Then comes a surprise: while in previous editions of the race checkpoints were
independent of each other, and competitors were able to choose freely whenever
there was more than one option, for the first half of the race we're forced to
choose among three fixed routes:
...
I don't really register all the options, but decide against opening the race
pack right now, as it'll be a hassle to get it out and back again into my
backpack in the minute or so before the race starts. I'll have time to check it
on my way to the Eurostar.

## Leg 1: London to Paris

The race starts as soon as the clock hits 10:30. I navigate through the crowd
with my bike and get on it as soon as possible, easily overtaking everyone else.
I'm in the lead!! The bike ride goes smoothly and I manage to get to a Victoria
line train in Brixton in just over 11 minutes.

The downside of this strategy is that the Victoria line doesn't have mobile
coverage yet, so for the 20 minutes I'm riding the tube I won't be able to check
itinerary options. What I can do is open the race pack and start locating where
the checkpoints are on the map.

With the help of the European Rail Atlas, I locate the most obscure ones,
Chamonix and Saint-Jean-Pied-de-Port, and see that both are in the French
railway network, and relatively close to major cities: Geneva and Bayonne,
respectively. At this point, of course, I don't need to worry too much about the
second half of the race, as all routes converge in Valencia.
...
should be easy enough, being so close to Bayonne. I know that the awful radial
design of the Spanish railway network means that the fastest way to get to
Santiago is probably going south, possibly all the way to Madrid, to go back up
north, and then backtrack to head to Valencia. However, there should be plenty
of connections available and a lot of them would involve high-speed trains.

The problem with the Mountain Goat route, which is the most direct one, is
Andorra, as getting to Chamonix, which is a major mountain resort town, and
really close to Turin and Geneva, shouldn't be too hard. But I already know that
the only way of getting to Andorra is by bus, either from Toulouse or Barcelona,
or from a nearby train station that is infrequently served by night trains from
Paris.

I don't really think much of the Island Hopper route. The Interrail map shows
that the ferry to Palma from Barcelona takes six and half hours, while the ferry
from Palma to Valencia takes nine. Surely the other two routes offer faster
options to get to Valencia.

While I'm still considering this, the train arrives to King's Cross St. Pancras
and it's time to overtake the tourists heading for Platform 9¾. I arrive to the
...
Since I had booked a first class seat at great expense, as it allows to check in
just 15 minutes before the train departs, instead of the usual 30, I decide to
make the most of it and access the first class lounge, where I'll also have
better Wi-Fi.

I grab a Coke Zero and start checking the itineraries. It seems that the journey
through Santiago is actually quite slow, as it looks like I won't be able to
make it to Valencia until at least Monday at 11:30 AM. The reason for that is
that there don't seem to be any overnight connections out of
Saint-Jean-Pied-de-Port, which means that I would be able to get there tonight,
but would have to wait until past 9:30 AM on Sunday to get back to Bayonne.

I start looking at the Mountain Goat route next. There is a TGV from Paris Gare
de Lyon to Geneva at 16:10 that looks quite attractive, as I'll arrive in Paris
at 14:53, so I should be able to board it just after clearing the two
checkpoints in the French capital. It also means that anyone that is taking the
next Eurostar to avoid the rush to St. Pancras won't be able to get it.
Furthermore, that TGV arrives to Geneva at 19:29, and I can take a bus to
Chamonix from there at 20:05, arriving at 22:00, which is quite fast considering
how remote Chamonix is.

The problem, I know, is going to be getting from the Alps to the Pyrenees and
into Andorra, but before I can check how much of problem that is going to be, I
hear the boarding call for my train. Not wanting to miss it, I finish my drink
...
screen, so I decide against it. I'm not totally happy to ser either: I knew some
more people were going to be able to catch the first Eurostar, but a boy can
hope...
...
last year, although coverage is patchy at best while still in England, improving
once we're in the channel and working perfectly fine once in France. In any
case, I get back to looking at my itinerary options. I was right in thinking
that getting through Andorra was going to be a pain, and from first glance it
seems that the fastest I could do it is going first to Barcelona and then back
up the Pyrenees again. However, this itinerary seems to place me in Valencia at
4:42 AM on Monday morning, which is not bad at all.

I then look at the Island Hopper route quite sceptically. I don't like to depend
on ferries, as their schedules can be capricious to say the least. A quick
...
Valencia at 8:00 AM on Monday, and depending on much less tight connections than
the Mountain Goat option, which from my calculations hinged on a 5-minute
connection in Narbonne.

I would of course not realize that the fastest route through Palma existed until
it was too late, with terrible consequences as you might be anticipating.
Looking back, however, I think I would still have taken the high-risk,
high-reward option of going through Chamonix and Andorra.

Time flies, though, and I need to commit to my plan: clear the Paris
checkpoints, and take the train to Geneva. Since this race was going to happen
through Spain, where the Interrail pass is largely useless, and Morocco, which
is not covered at all by it, I have decided not to purchase one, so I'll need to
pay full price on tickets. The last-minute ticket price for the international
TGV to Geneva is so high, over €180, that it's actually cheaper to buy the SNCF
Advantage discount card, which costs €50. Since it's also only over €5 to
upgrade to first class, I think that I might as well do that.
...
Turns out that instead of doing the sensible thing and allow contactless cards
to be used to pay at the turnstiles, you have to buy tickets on your phone via
the Bonjour RATP app. I install the app, sign up, and try to buy tickets before
discovering that to do that you need to install a second app that just runs the
background process to hold and activate the tickets. After spending too much
time setting up the bloody thing, running device compatibility checks, and
reciting the Marseillaise in reverse three times, I finally manage to purchase
three single tickets and get on with my day. By now, though, Paris is getting
really close.

## Leg 2: Paris to Chamonix

The Eurostar actually pulls into Gare du Nord 5 minutes early, at 14:48, and as
...
- The second one depends on which of the three itineraries you've chosen. For
  ...
  **Montmartre** as to get acquainted with heights, and take a photo of **Le
...
realized that , I could have gone to Montmartre first, then to Lauduree, and
then to Gare de Lyon, doing a counter-clockwise tour through the Rive Droîte.
...
Instead, I assumed that I had to go to Ladurée first. That means that I have to
south from the Gare du Nord down to the patîsserie, then go back up north to
Montmartre, before tracing a long diagonal to the southeast to get to Gare de
Lyon. I should still be able to make it, but I'm going to need to run
...
three routes (that's the first thing I checked back in St. Pancras), I wonder
for a moment if this race's competition isn't going to be so fierce as the
previous one, before realizing that there's no way that is going to be the case.

At 15:11, with just 59 minutes to the departure of my next train, I clear the
Ladurée checkpoint. I consider actually buying macarrons for a millisecond
before processing how stupid of an idea that would be. Sam S. was there with me,
and when I look back at her after a couple of seconds she's meters ahead on the
way to the Concorde metro station. That's a wake-up call and I decide to give
her a run for her money and sprint ahead like a mad man. We both laugh as we
both audibly laugh. That's what great about the Lupine Race: the competition is
absolutely real and fierce, but everyone takes it in good spirits.

I arrive into Place Concorde trying to find the entrance to the metro station. I
wait to cross the street and in that time Sam S. catches up with me. I was
engrossed looking at the map trying to see the entrance, and she takes the lead
crossing the road. I start running again, but look back on the left and spot a
stone balustrade –that must be an entrance, and, in fact it, is. I devilishly
laugh at leaving Sam. S fending by herself, not knowing that she's going to take
an entirely different route and I won't see her again until a few days later.
...
Geneva to Chamonix. Being under the hill of Montmartre, the station is deep, 25
m underground, and has no escalators, only a lift and a spiral staircase. I'm
quite lucky though, as I managed to catch a lift about to depart while I was
already looking for the stairs.

Once on the ground, I make a mistake and go down the steep staircase in front of
the station. Fortunately, it only takes a few meters to realize my mistake and
turn back. Already strapped for time, I run uphill dodging tourists and dash
through Montmarte approaching the checkpoint. On the crossroads next to the
sculpture, I have a couple seconds of doubt. There's another team of racers
there and when they see me looking around at back at my phone, slightly
...
Montmartre by so much probably doesn't help with my confused expression as, once
again, I didn't realize you could go there first before visiting one of the
pâtisseries.

I don't think the way they're pointing is right, but I don't think twice about
it and follow their indication. A few metres later I realized that there is no
way the checkpoint is that way, and I turn back again and head to the
...
rules of the race, although I choose not to say anything because I think it
wasn't done in bad faith, and it didn't cause me too much trouble, although it
could, as I need to go to the other side of Paris to catch a train that leaves
in 36 minutes and has costed me a small fortune, and missing one metro train can
lead to me missing it. I think they're probably first-timers that don't fully
comprehend how devastating the implications of those shenanigans could be, and
have other things to worry about at the moment.

Being completely honest, thinking back about it as I write this lines, I'm
getting belated anger, as now I can fully realize the potential ramifications of
...
came from. I'm really lucky and a train arrives almost as soon as I get onto the
platform, after breezing down the spiral staircase. The Line 12 train seems to
take forever to go back to Madeleine, where I change to the modern Line 14,
taking me all the way to Gare de Lyon where I finally arrive at 15:57.

I make it all the way to my train with 8 minutes to spare. It's curious how your
mindset changes when doing this race. I'm normally the kind of person that
wastes too much time at airports, because I can't bring myself to arrive less
than 2 hours before a flight. Now I'm getting to a train station less than 10
minutes before departure, and it feels like plenty.

Anyway, I find my way to my seat, which I'm glad to have booked on the upper
deck. Not that there were many seats available, though: I had to get a seat in a
...
thankfully I manage to get consistenly good reception for almost the whole trip.
Time to polish my plan.

At this point, I'm fully commited to this route now, there's no way to turn back
and choose any of the other options. I'm still quite confident I've made the
right choice, though.

The first thing I need to do is figure out what the Chamonix checkpoint is. Last
year, the checkpoint locations where specified in the Race Pack down to the
exact coordinates (well, what3words location). This time around, they're hidden
behind easy-to-solve riddles. We're told to take a picture of the two separate
statues that honor the first climbers of the Mont Blanc.
...
its own on the Google Maps entry. A quick inspection with streetview and a
couple of external sources confirm the location, though.
...
There are a lot of services departing from Barcelona, and that's why my original
itinerary goes there. But as I mentioned above, that hinges on quite a few tight
connections. It would look like this:

1.  Getting to Lyon before 10:00 AM. That part is easy as there are a couple of
    options that I could take that would give me plenty of time to spare.
...
3.  Arriving to Perpignan at 13:48, and from there take either the 14:00
    BlaBlaCar Bus or the 14:05 Flixbus coaches to Barcelona, arriving to the
    ...
    Girona; while the latter departs from Lyon at 7:30, making the same
    intermediate stops except Girona, meaning that it runs direct from Perpignan
    to Barcelona. While this would be my preferred option, I know that bus
    timetables are unreliable to say the least, specially in a case like this
    when they have been running for hours before the stop where I would board.
    As long as any of the two are remotely within schedule, though, I should be
    fine.

4.  Crossing Barcelona in less than 45 minutes to take the bus to Andorra at
    17:15 from the Zona Universitària metro stop. This is quite a short time
    window, and that's why relying on buses to get to Barcelona makes me a bit
    uneasy.

Getting that bus to Andorra is quite important, as it would leave me there at
20:00, although in practice it would probably arrive earlier, since from what I
can see the timetables have a lot of built-in room for slack. Once in Andorra La
Vella, clearing the checkpoint should be a breeze, as the required proof is
getting a picture of the Andorran coat of arms, which I reckon should be quite
easy, specially knowing that is featured in the national flag.

The important bit is that I need to catch the 20:15 bus from Andorra to
Barcelona. That would put me back there at 23:15, which leaves me enough time to
catch the 23:59 or 01:00 overnight buses to Valencia. After that, the next
...
to do that, when I look out of the window and realize that we must be getting
...
have over 30 minutes to change, I can go the waterside and see the lake and the
infamous water jet. I'm looking forward to that, as I've never been here before
and the weather is extraordinary.

I get off the train, and get surprised by having to go through customs, although
it makes sense. While Switzerland is part of Schengen, and therefore there are
no passport controls, it is not part of the EU or its Customs Union. Out of the
...
In the 500-metre walk down to Lac Leman I locate the coach stop, just to my
right. At some point, someone in the group chat asks a question about the Toulon
checkpoint and I enter in full panic mode. If someone is getting there fast,
that probably means that they're competing for the win and that maybe I have
missed something big. Have I already lost the race, on day one? I quickly check
the schedules of the overnight Touloun - Mallorca ferries, and to my relief they
only happen on Mondays and Wednesdays. The fact that I was completely oblivious
to that is foreshadowing. In any case, now it's time to relax for a couple of
minutes with the view of Geneva by Lac Leman.

As I'm making my way back to the coach station, I see that someone is asking in
the group chat if there's someone in Geneva. I have supposed I had company, but
it will be interesting to see how many. I haven't seen Sam S. since Laudurée,
and that spooks me a little bit, since she was clearly competing intensely for
the win: what may I have missed that she knows?

Anyway, the person asking wasn't even in Geneva yet, just on their way there.
However, Dave, who I met last year
...
expected the bus to depart exactly on time, being run by a Swiss company, but it
actually departs one minute early, with only about 5 people on board. It's
20:04, and we're expected to get to Chamonix at 22:00.
...
ahead of us. A French-speaking Swiss woman seating behind us overhears us and
asks us what we do, and we explain what the Lupine race is to her and have a
chat about it and the area we're currently in.

Dave has told me that he plans to spend the night in Chamonix, and I figure out
I need to decide what to do. The idea of sleeping in a bed, while nice, sounds
soul-crushing in a certain way: that's not what you're supposed to do during the
race.

As far as I can see, I have a few options to get out of Chamonix, both getting
me to Lyon's main station before 10:10, in time for the dash to Barcelona, but
no option that would allow me to get earlier to Andorra, which is my real
objective. There's an option to take a bus at 6:00 AM, making it to Lyon at
9:50, only 20 minutes before my train and not even to the same station. That's
too close for comfort, so I opt for the second option: taking a bus to Paris at
00:20, stepping out at Dijon at 04:20, and from there catch the first train of
the day to Lyon, arriving at the main station at 08:44.
...
there to Andorra. Come on, it's not that far awy, right? _Right?_ I pull up
...
As far as I can see, this wouldn't make a huge difference in the time I'd arrive
in Marrakesh, as it would only translate in an earlier arrival to Valencia at
02:15 AM, but I'd still would have to wait to the same first train out of there
in the morning. Anyway, gaining so much time is really worth it, as I'd
eliminate my dependency on nail-biting connections.
...
I'm exhilarating, feeling so happy to have spotted this while my fellow racer
...
from the Swiss one... And I still see the same thing. What's going on?? And
that's when I look back in the timetable and notice the small print: the service
...
self-frustration, and we arrive in Chamonix. Dave and I go find the two
monuments that we have to photograph to clear the checkpoints. I wonder what
...
In any case, we make it to the town main square at 22:14, where we take the
required selfies with both statues. Then Dave asks me if I want to have dinner
with him, to which I of course say yes, not having eaten anything in all day.
Few places are still open by that time, so we end up settling for a burger
stall. Dave even buys me a beer which tastes great. During dinner, he convinces
me of getting a hotel room, even if it is for a few hours, and I start seeing
the appeal of the option, even if it's just for a few hours. I finally bit the
bullet and book it.

After the restorative dinner, Dave and I part ways, and I set course to my
hotel, 5 minutes away. Tomorrow is going to be the decisive day that makes or
breaks my race, so I better rest up as much as I can.
...
double-check the address, when I realize that the booking hasn't gone through.
...
and I know that some of the racers that took the second Eurostar and have opted
...
limited transport options means that anyone who's made it here now is on the
same position.
...
shuteye... but I don't. I try to put my insomnia to good use and see if I can
spot a new, faster, route, but I don't have my heart on it. I know that I'm
already on the best possible itinerary, and my only hope is that there are no
major hiccups. What I can do now is book tickets for the next few legs, which I
do. I get my tickets, to Barcelona, Andorra, and Valencia. When I try to get my
train tickets from Valencia to Málaga via Madrid, I realize that Renfe's mobile
app puts the accepted card types logos on top of the CVC field, so you have to
fiddle until you manage to tap on one of the few free pixels... That not being
funny enough, once I manage to put in my card details and proceed, the system
has entered maintenance mode. Ah, good old Renfe
...
until my train, and nothing to do other than wonder around the old town. I've
never seen anything from Dijon before, I only knew it because of the mustard, so
I'm delighted to discover that it is a lovely old city. The streets are empty at
this time of the morning, except for some scattered drunkards on their way back
home.
...
After wondering through the city for a couple of hours, I arrive back to the
train station, and I'm surprised that there's actually quite a few people to
catch the first train of the day on a Sunday morning. I try to find any place
...
Success! I try to catch some sleep, but the rising sun is not helping, although
I manage to get about 20 minutes before arriving in Lyon at 08:45.

Now my mission is to find breakfast before my train at 10:10. Being in France, I
want to get a nice croissant, but most of the bakeries are closed on Sunday.
After a little research, I manage to find one open inside the market, and I
promptly get a croissant and a pain au chocolat. Oh, they are so good. The
French really know what they're doing.
...
that 20 minute delay, all those plans collapse like a house of cards. I know
there's no chance the train is going to make up enough time to make my
connection in Narbonne.

So... what now? I know there's not any better option than to take that same
train to its final destination, Toulouse, and go from there to Andorra, but that
means abandoning any hopes of going overnight to Valencia. I go check the
departure boards, in the off-chance that I've missed any other train that could
get me there sooner.

I find Dave looking at the screens, and joining him is also Andrew M., who
arrived in Chamonix on the same bus as Alex L. last night, but I didn't see
disembarking. We catch up on the developments, and Dave tells me that he in fact
got the 3:26 bus in company of Alex, who appears to have decided on the spot to
...
leaving a little bit over 20 minutes late, and I settle down for another long
journey in a table seat. Just my luck.

I'll go through the five stages of grief during the day, but not necessarily in
order. Denial went off pretty quickly in Lyon while I processed the
ramifications of the delay. I knew that the plan was very tight and risky,
however I was afraid of delayed buses, the TGV should have been the reliable
part. It was also the first part of the itinerary, which makes the whole thing
even worse.

Anyway, it's time to enter the bargaining stage, and try to see if there's any
way I could still arrive relatively early to Valencia. As things stand right
now, it seems that this seemingly inoffensive 20 minute delay is going to make
me arrive to the finish line exactly 12 hours later than I originally planned.
My itinerary to Valencia looks like this at the moment:

- This train, arriving in Toulouse at approximately 14:35 accounting for the
  delay
...
solid couple of hours, I find nothing. Nothing except something very weird. I
can see that there is a Flixbus service coming from France that stops in
Barcelona at 2:15 AM, that arrives in Valencia at 6:30 AM. While this isn't as
good as my original plan, it is still much better than arriving after 10 AM. The
only problem is that I can't book it. The Flixbus site allows to buy tickets
from any of the stops in France, but not from anywhere in Spain.
...
see a Renfe train. For a second it seems that I may be able to jum and get on my
way to Barcelona, but I soon realize that said train is going the opposite way,
back.

After a gruelling journey where I don't catch much sleep, we finally arrive in
Toulouse. I reunite with Dav and Andrew, and we all go together to the bus
station to check that at least the 17:45 bus to Andorra exists and is scheduled.
...
to double-check if it's corked or something, only to pour a full serving and
then, not so subtly, bring the glass to one of his mates on other table. Cheeky
little bastard. We all desist to argue, because we're all low on energy, and we
have other things to focus on.

Over the lunch, where I try frog legs for the first time in my life (the really
do taste just like chicken), we discuss the situation we find ourselves in. I
make a pact with them: I reveal the existence of the 'ghost' unbookable bus from
Barcelona, in exchange they need to share with me a way to book it if they find
one.

We also analyse our standings in the race, as we might as well still be in the
lead after all this trouble. The groups going through Santiago don't seem to
have moved much from the French Basque Country, which is bizarre. Maybe there
are no competitors there. What about the people going through Mallorca? Well, I
soon realize that I was very wrong in dismissing that route out of hand. They
appear to just have left the port of Barcelona, on a ferry on the way to
Alcudia, on the north end of the island. We quickly check what their options are
from there... And the picture doesn't look good for us. They are able to cross
the island to Palma in the South, clear the checkpoint there, and be on their
way to Valencia on an overnight ferry. Unless there are any hiccups, they will
arrive in Valencia two hours ahead of us, which doesn't seem like much, but it
is, as it will allow them to fly past Spain while we are going to be stuck in
2-hour long service gaps along the way.

Our chances of wining are slim. There are only two paths to victory for us:
...
We get early to the bus station –there is no chance we are going to miss our bus
to Andorra, and soon Ben P., who I had also met during last year's race, appears
and joins our group. Our transport, a mini-bus (emphasis on mini), promptly
appears, and we depart on time.

After a brief stop at the Toulouse-Blagnac Airport, where I have the chance to
spot a Beluga XL, we're on our way to Andorra. I try any option I can find to
book the 'ghost' bus. Every possible reseller. Every bus comparison website.
...
amount of time to some horrible holding music, I manage to speak with a FlixBus
rep. I explain the situation, give all the details, but the answer that I get is
the one I anticipated: computer says no.
...
rushed and tired to properly take them in.
...
the bus arrives, I need to be alone and split off the group. As I anticipated,
the task for the Andorra checkpoint is quite easy: we're supposed to take a
photo with a depiction of the Principality's Coat of Arms. As soon as I step off
the bus, I find the first one on its number plate. I'll collect a few more as I
walk through the steep streets of the capital's old quarter.
...
I get back to the bus station at 22:00, and I meet Andrew and Dave. Soon, we get
more bad news.
...
as soon as the bus starts going, only to be woken up on the border. Two Spanish
policemen board to check passports and customs, which takes quite a bit longer
than I expected.

The next time I wake up, we're already in Barcelona. We arrive in Sants Station
at 1:53 in the morning. The 'ghost' bus is scheduled to get there at around
2:10 - 2:15. In anticipation, I have bought tickets on that bus from Perpignan
to Valencia. FlixBus' policy states that you're not allowed to board a bus on a
later stop than the one you book, but one has to try.

As the native Spanish speaker in the group, I prepare myself to plead with the
driver, perhaps improvising some sort of sob story. I open the FlixBus tracker,
to see how far away the bus is, and to my delight it is already quite near us,
just five minutes away. Except... wait a second. It's actually five minutes past
us.
...
The first train to Valencia departs at 7:15. I take a look at nearby hotel and
hostel prices, but they're through the roof. Unwilling to waste more money
(thank good I at least got refundable tickets for the expensive Valencia -
Madrid - Málaga leg), I resign myself to mindlessly wonder the streets of the
Catalan capital. At least I have
...
station, which is now open. They layout of Barcelona Sants is a terrible maze,
caused by the stupid boarding proceedings of Spanish long-distance trains.
Instead of just walking into the station and going to your platform, like any
normal country, you have to arrive with plenty of time, wait until your platform
is announced, pass through airport-style security, and then queue to enter the
platform when directed by the staff. As a result, the station has been made into
a cumbersome labyrinth to separate different areas. There's also not much
seating (why would yu need that in a major transport hub anyway?), but I manage
to find some, and collapse down into it. To add insult to injury, the toilets
(which of course are not free) do not even open until at least an hour after the
station.
...
my horror, I realize that I have been drooling quite a bit. There's visible
puddle on my t-shirt. It's a good spectacle I've given to those sales reps.
...
the way on any further sleep, but it's still a good trade-off.

The train pulls into Valencia Nord station just a few minutes late, and I set
myself to go clear the checkpoint. Before leaving, I spend a couple of minutes
admiring the impressive modernist architecture of the station building.
Valencia's main station, Joaquín Sorolla is nothing more than a glorified bus
shelter, but Nord is a charming building.
...
It's a 20-minute walk through the beautiful streets of Valencia's city center to
...
Valencia without a hiccup, were here only 2 hours before me. But, because of
train schedules, while they're well on their way to Madrid (again, that's the
design of the Spanish Railway Network, in order to go anywhere you first have to
go to Madrid), I still need to wait here for almost two hours.
